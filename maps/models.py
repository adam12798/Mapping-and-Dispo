...
class Lead(models.Model):
    ...
    monthly_cost = models.CharField(max_length=100, blank=True)
    total_cost = models.CharField(max_length=100, blank=True)
    adders = models.TextField(blank=True)
    post_appt_notes = models.TextField(blank=True)
