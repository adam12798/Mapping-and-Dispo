...
urlpatterns = [
    ...
    path('org/audit/', views.org_audit, name='org_audit'),
    ...
    path('api/ghl-builder/', views.ghl_webhook_builder_api, name='ghl_builder'),
    path('api/webhook-configs/', views.webhook_config_api, name='webhook_configs'),
